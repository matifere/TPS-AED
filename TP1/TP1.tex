...
\pred{matrizCuadradaSimetrica}{matriz: \TLista{\TLista{\ent}}}{
	\paraTodo{i,j,k}{\ent}{
		\left( \left( 0 \leq i,j,k < |matriz| \right) \yLuego \left( 0 \leq i,j < |matriz[k]| \right) \right)  \implicaLuego \\ \left( \left( i = j \right) \longrightarrow \left( matriz[i][j] = 0 \right) \right) \wedge \left( matriz[i][j] = matriz[j][i] \right)
	}
}

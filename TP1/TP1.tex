...
.		\}} 
	\asegura{\{ 
		\paraTodo{m,n}{\ent}{ 0 \leq m,n < |menoresDeCiudades| $\wedge$ $\left( menoresDeCiudades[n]_{0} = mayoresDeCiudades[m]_{0} \right) \wedge \\ \left( \langle menoresDeCiudades[n]_{0}, menoresDeCiudades[n]_{1} + mayoresDeCiudades[m]_{1} \rangle \in \res \right)$}
		 \}}
\end{proc} \}

...
wp \left(S1;S2,P_{c}\right) \equiv wp\left(res:=0; i:=0, P_{c} \right) \equiv wp\left( res:=0,def(i) \yLuego P_{c} \right) \equiv def(res) \yLuego P_{c} \equiv P_{c} \vspace{0.3cm}\\
P \longrightarrow P_{c}

...
\begin{proc}{cantidadCaminosNSaltos}{\Inout conexión : \TLista{\TLista{\ent}}, \In n : \ent}{ \{
		...
		\asegura{
			$\{ \existe{p}{\TLista{\TLista{\TLista{\ent}}}}{ \left( p[0] = C_{0} \right) \implicaLuego \paraTodo{k}{\ent}{
						\left( \left( 0 < k < n \right)  
						\implicaLuego \left( multEntreMatrices(p[k-1], p[k-1], p[k])  \right)\right)
						\yLuego \\
						\left(  multEntreMatrices(p[n-1], p[n-1], conexi \acute{o} n) \right) }  } \}$ \\
		}

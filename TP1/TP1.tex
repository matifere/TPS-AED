...
\begin{proc}{hayCamino}{\In distancias : \TLista{\TLista{\ent}}, \In desde : \ent, \In hasta : \ent}{\bool \{ } 
	...
	%cambie el rango de k para que no se rompa (no estoy seguro de que tenga que ser asi)
	    \asegura{
		\{ 
		...
		\existe{p}{\TLista{\ent}}{
			...
			$\wedge$ \paraTodo{k}{\ent}{ \ \ \ \ \ \  $\left( 0 \leq k < |p|-2 \right)$  $\rightarrow$$\left( distancias[p[k]][p[k+1]]\textgreater 0 \right)$}}
		\}
	}
	\}
\end{proc}

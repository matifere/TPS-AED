...
\begin{proc}{caminoMinimo}{\In origen : \ent, \In destino : \ent, \In distancias : \TLista{\TLista{\ent}}}{\TLista{\ent} \{ }{
	...
	\pred{menorCamino}{distancias : \TLista{\TLista{\ent}}, origen : \ent, destino : \ent, resu : \TLista{\ent}}{$ \{
			\existe{p}{\TLista{\ent}}{
				esCamino(distancias, origen, destino, p) \yLuego \paraTodo{k}{\TLista{\ent}}{
					esCamino(distancias, origen, destino, k) \implicaLuego
					((\sum_{n = 1}^{|p|-1} distancias[p[n-1]][p[n]]) \leq $ \\ $(\sum_{n = 1}^{|k|-1} distancias[k[n-1]][k[n]]) ) \yLuego \left( resu = p\right)
				}
			}
		
			\}	
			$}
	\pred{esCamino}{distancias : \TLista{\TLista{\ent}}, desde : \ent, hasta : \ent, listaComparar : \TLista{\ent}  }{ \{ 
				$
					\existe{p}{\TLista{\ent}}{
						\left( |p| > 1 \right) \yLuego (
						\left( p[0] = desde \right) \wedge

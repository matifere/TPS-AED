...
\begin{proc}{hayCamino}{\In distancias : \TLista{\TLista{\ent}}, \In desde : \ent, \In hasta : \ent}{\bool \{ } 
	\requiere{\{ (\paraTodo{i,j}{\ent}{ $\left( 0 \leq i,j,desde,hasta < \sqrt{\text{distancias.Length}} \right)$ $\yLuego$ $\left( \left( i = j\right) \longrightarrow \left( distancias[i][j] = 0 \right) \right)$ $\wedge$ $\left( distancias[i][j] = distancias[j][i] \right)$} \}}
	\asegura{\{\True\}}
	\}
\end{proc}

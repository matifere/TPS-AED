...
\pred{estaIncluida}{s : \TLista{Ciudad}, t : \TLista{Ciudad}}{
	\paraTodo{e}{Ciudad}{(e \in s) \implica (\# apariciones(e,s) \leq \# apariciones(e,t))}
}
...
\pred{matrizCuadradaSimetrica}{matriz: \TLista{\TLista{\ent}}}{
	\paraTodo{i,j,k}{\ent}{
		\left( \left( 0 \leq i,j,k < |matriz| \right) \implicaLuego \left( |matriz[k]| = |matriz| \right) \right)  \implicaLuego \\ \left( \left( i = j \right) \longrightarrow \left( matriz[i][j] = 0 \right) \right) \lor \left( matriz[i][j] = matriz[j][i] \right)
	}
}
